...
class Log:
    ...
    _last_message = ""  # Track the last logged message
    ...
    def warn(*args, tag=None):
        """
        Output WARN level log information, preventing repetitive prints.
        """
        message = " ".join(map(str, args))
        if Log._should_log(tag) and message != Log._last_message:
            Log._last_message = message
